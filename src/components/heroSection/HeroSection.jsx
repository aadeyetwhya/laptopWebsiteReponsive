...
function HeroSection() {
    return (
        <div className='w-full bg-black text-white lg:flex lg:justify-between py-3 px-3 text-justify mt-0.5 lg:mt-0'>
            <div className="heroTexts text-center lg:flex lg:flex-col lg:justify-center  ">
                <div className="title text-xl lg:text-3xl">
                    Buy with Lap Setu
                </div>
                <div className="discription text-sm lg:text-xl pt-8">
                ...
                <div className="quote pt-3 text-lg italic text-red-800 lg:text-2xl">
